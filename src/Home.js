    ...
    return(
        <div className="App">
            ...
            <div className='first-page'>
                <img src={`./firstpage1.jpg`} width='350px'height='250px' alt='art' className='art-block'/> 
                <img src={`./firstpage2.jpg`} width='350px' height='250px'alt='art' className='art-block'/> 
                <img src={`./firstpage3.jpg`} width='350px'height='250px' alt='art'className='art-block'/> 
                <img src={`./firstpage4.jpg`} width='350px'height='250px' alt='art' className='art-block'/> 
            </div>
            <div className='block'>
